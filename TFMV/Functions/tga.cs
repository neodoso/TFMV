        ...
        private void LoadTGAFooterInfo(BinaryReader binReader)
        {
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                ...
                try
                {
                    ...
                    binReader.BaseStream.Seek((tga.FooterSignatureOffsetFromEnd * -1), SeekOrigin.End);

                    // read the signature bytes and convert to ascii string
                    string Signature = System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.FooterSignatureByteLength)).TrimEnd('\0');

                    // do we have a proper signature
                    if (string.Compare(Signature, tga.TargaFooterASCIISignature) == 0)
                    {
                        ...
                        binReader.BaseStream.Seek((tga.FooterByteLength * -1), SeekOrigin.End);
                        ...
                        binReader.ReadBytes(tga.FooterSignatureByteLength);

                        // read the reserved character
                        string ResChar = System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.FooterReservedCharByteLength)).TrimEnd('\0');
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                ...
                if (this.objTargaFooter.ExtensionAreaOffset > 0)
                {
                    try
                    {
                        ...
                        this.objTargaExtensionArea.SetAuthorName(System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.ExtensionAreaAuthorNameByteLength)).TrimEnd('\0'));
                        this.objTargaExtensionArea.SetAuthorComments(System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.ExtensionAreaAuthorCommentsByteLength)).TrimEnd('\0'));
                        ...
                        this.objTargaExtensionArea.SetJobName(System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.ExtensionAreaJobNameByteLength)).TrimEnd('\0'));
                        ...
                        this.objTargaExtensionArea.SetSoftwareID(System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.ExtensionAreaSoftwareIDByteLength)).TrimEnd('\0'));


                        // get the version number and letter from file
                        float iVersionNumber = (float)binReader.ReadInt16() / 100.0F;
                        string strVersionLetter = System.Text.Encoding.ASCII.GetString(binReader.ReadBytes(tga.ExtensionAreaSoftwareVersionLetterByteLength)).TrimEnd('\0');
                        ...
                        if (this.objTargaExtensionArea.ColorCorrectionOffset > 0)
                        {
                            ...
                            for (int i = 0; i < tga.ExtensionAreaColorCorrectionTableValueLength; i++)
                            {
    ...
    public class TargaHeader
    {
        ...
        public int ImageDataOffset
        {
            get
            {
                ...
                int intImageDataOffset = tga.HeaderByteLength;
